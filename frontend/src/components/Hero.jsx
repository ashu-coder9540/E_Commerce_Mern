    ...
    <section className="bg-gradient-to-r from-green-100  to-white px-6 py-12 md:flex items-center justify-between max-w-7xl mx-auto rounded-xl mt-24">
      <div className="md:w-1/2 space-y-4">
        ...
        <p className="text-gray-800">
         Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur ex sed quam cupiditate velit corporis, pariatur ea deserunt repellat in ratione minus nesciunt quibusdam recusandae beatae quas expedita laborum rem?
        </p>
